...
btn.addEventListener('click', function () {
    ...
    // if (pfc[resultat] == li[alea-1].textContent){
    //     res.innerHTML = 'égalité' ;
    // }else if (pfc[resultat]=='bombe' && li[alea-1].textContent == 'eventail'){
    //     res.innerHTML = 'Perdu !' ;
    // }else if(pfc[resultat]=='eventail' && li[alea-1].textContent == 'bombe'){
    //     res.innerHTML = 'Gagné !' ;
    // }else if (pfc[resultat]=='bombe' && li[alea-1].textContent == 'excalibur'){
    //     res.innerHTML = 'Gagné !' ;
    // }else if(pfc[resultat]=='excalibur' && li[alea-1].textContent == 'bombe'){
    //     res.innerHTML = 'Perdu !' ;
    // }else if (pfc[resultat]=='excalibur' && li[alea-1].textContent == 'eventail'){
    //     res.innerHTML = 'Gagné !' ;
    // }else if (pfc[resultat]=='eventail' && li[alea-1].textContent == 'excalibur'){
    //     res.innerHTML = 'Perdu !' ;
    // }else if (pfc[resultat]=='excalibur' && li[alea-1].textContent == 'bombe'){
    //     res.innerHTML = 'Perdu !' ;
    // }else if (pfc[resultat]=='bombe' && li[alea-1].textContent == 'excalibur'){
